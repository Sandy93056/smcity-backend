    ...
    def post(self, request):
        ...
        try :
            ...
            if user.is_verified and user.user_type=="customer":
                data = request.data
                o = organization(user=request.user, bank_acc_no=data["bank_acc_no"], bank_name=data["bank_name"],bank_acc_name=data["bank_acc_name"],bank_ifsc=data["bank_ifsc"])
                o.save()
                o.org_is_active = True
                user.user_type = "organization"
                user.save()
                msg = {
                    "msg":"you are now a organization",
                    "res": "successful"
                }
